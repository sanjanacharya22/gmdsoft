...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 24, 2024 at 07:31 AM
...
CREATE TABLE IF NOT EXISTS `lkp_cust_timezone` (
  ...
  KEY `lang_id` (`lang_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='hold customer time zone format';
...
CREATE TABLE IF NOT EXISTS `lkp_package_family` (
  ...
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  UNIQUE KEY `unique_pack_family_lang_id` (`pack_family`,`lang_id`),
  KEY `lang_id` (`lang_id`)
...
--
-- Table structure for table `lkp_package_files`
--

DROP TABLE IF EXISTS `lkp_package_files`;
CREATE TABLE IF NOT EXISTS `lkp_package_files` (
  `id` smallint UNSIGNED NOT NULL,
  `package_files` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  UNIQUE KEY `unique_package_files_lang_id` (`package_files`,`lang_id`),
  KEY `lang_id` (`lang_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='holds file name of a package';
...
CREATE TABLE IF NOT EXISTS `mst_package` (
  ...
  `package_files_id` smallint UNSIGNED NOT NULL COMMENT 'file name',
  ...
  KEY `prod_id` (`prod_id`),
  KEY `package_files_id` (`package_files_id`)
...
--
-- Constraints for table `lkp_package_files`
--
ALTER TABLE `lkp_package_files`
  ADD CONSTRAINT `lkp_package_files_ibfk_1` FOREIGN KEY (`lang_id`) REFERENCES `lkp_lang` (`id`) ON DELETE RESTRICT;
...
ALTER TABLE `mst_package`
  ...
  ADD CONSTRAINT `mst_package_ibfk_7` FOREIGN KEY (`package_files_id`) REFERENCES `lkp_package_files` (`id`) ON DELETE RESTRICT;
