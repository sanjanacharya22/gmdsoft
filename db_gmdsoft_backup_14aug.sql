...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 14, 2024 at 11:56 AM
...
CREATE TABLE IF NOT EXISTS `lkp_brand_model` (
  `id` smallint UNSIGNED NOT NULL,
  `brand_model` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_delivery_type` (
  `id` smallint UNSIGNED NOT NULL,
  `delivery_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  KEY `lang_id` (`lang_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='N, T, AND, D';
...
CREATE TABLE IF NOT EXISTS `lkp_deployment_type` (
  `id` smallint UNSIGNED NOT NULL,
  `deployment_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_dongle_deal_classification` (
  `id` smallint UNSIGNED NOT NULL,
  `deal_classification` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_faq_type` (
  `id` smallint UNSIGNED NOT NULL,
  `faq_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_firmware_brand` (
  `id` smallint UNSIGNED NOT NULL,
  `firmware_brand` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_firmware_os` (
  `id` smallint UNSIGNED NOT NULL,
  `firmware_os` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_guide_type` (
  `id` smallint UNSIGNED NOT NULL,
  `guide_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_lang` (
  ...
  `is_active` tinyint NOT NULL DEFAULT '0' COMMENT '0: not active, 1; Active',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `lkp_mail_classification` (
  `id` smallint UNSIGNED NOT NULL,
  `mail_classification` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_mail_grp_type` (
  `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT,
  `mail_grp_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_mail_sent_status` (
  `id` smallint UNSIGNED NOT NULL,
  `mail_sent_status` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_mail_summary_status` (
  `id` smallint UNSIGNED NOT NULL,
  `mail_summary_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_mail_title` (
  `id` smallint UNSIGNED NOT NULL,
  `mail_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_noti_status` (
  `id` smallint UNSIGNED NOT NULL,
  `noti_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_noti_type` (
  `id` smallint UNSIGNED NOT NULL,
  `noti_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_region_sub_type` (
  `id` smallint UNSIGNED NOT NULL,
  `region_sub_type` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_region_type` (
  `id` smallint UNSIGNED NOT NULL,
  `region_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_resource_file_name` (
  `id` smallint UNSIGNED NOT NULL,
  `resource_file_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_resource_info` (
  `id` smallint UNSIGNED NOT NULL,
  `resource_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_user_role_lang_id` (`user_role`)
...
CREATE TABLE IF NOT EXISTS `lkp_scope_of_disclosure` (
  `id` smallint UNSIGNED NOT NULL,
  `scope_of_disclosure` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
CREATE TABLE IF NOT EXISTS `lkp_ticket_status` (
  `id` smallint UNSIGNED NOT NULL,
  `ticket_status` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
...
--
-- Table structure for table `lkp_user_cate`
--

DROP TABLE IF EXISTS `lkp_user_cate`;
CREATE TABLE IF NOT EXISTS `lkp_user_cate` (
  `id` smallint UNSIGNED NOT NULL,
  `user_cate` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  UNIQUE KEY `unique_user_cate_lang_id` (`user_cate`,`lang_id`),
  KEY `lang_id` (`lang_id`)
...
--
-- Table structure for table `lkp_user_dateformat`
--

DROP TABLE IF EXISTS `lkp_user_dateformat`;
CREATE TABLE IF NOT EXISTS `lkp_user_dateformat` (
  `id` smallint UNSIGNED NOT NULL,
  `user_dateformat` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  UNIQUE KEY `unique_user_dateformat_lang_id` (`user_dateformat`,`lang_id`),
  KEY `lang_id` (`lang_id`)
...
--
-- Table structure for table `lkp_user_grp_lvl_1`
--

DROP TABLE IF EXISTS `lkp_user_grp_lvl_1`;
CREATE TABLE IF NOT EXISTS `lkp_user_grp_lvl_1` (
  `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT,
  `grp_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_user_grp_lang_id` (`grp_name`)
...
--
-- Table structure for table `lkp_user_grp_lvl_2`
--

DROP TABLE IF EXISTS `lkp_user_grp_lvl_2`;
CREATE TABLE IF NOT EXISTS `lkp_user_grp_lvl_2` (
  `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT,
  `grp_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `lkp_user_grp_lvl_3`
--

DROP TABLE IF EXISTS `lkp_user_grp_lvl_3`;
CREATE TABLE IF NOT EXISTS `lkp_user_grp_lvl_3` (
  `id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT,
  `grp_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `grp_type` tinyint NOT NULL DEFAULT '0' COMMENT '0: normal grp, 1: parter grp	',
  PRIMARY KEY (`id`),
  UNIQUE KEY `grp_name` (`grp_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `lkp_user_status`
--

DROP TABLE IF EXISTS `lkp_user_status`;
CREATE TABLE IF NOT EXISTS `lkp_user_status` (
  `id` smallint UNSIGNED NOT NULL,
  `user_status` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  UNIQUE KEY `unique_user_status_lang_id` (`user_status`,`lang_id`),
  KEY `lang_id` (`lang_id`)
...
--
-- Table structure for table `lkp_user_timezone`
--

DROP TABLE IF EXISTS `lkp_user_timezone`;
CREATE TABLE IF NOT EXISTS `lkp_user_timezone` (
  `id` smallint UNSIGNED NOT NULL,
  `user_timezone` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  UNIQUE KEY `unique_user_timezone_lang_id` (`user_timezone`,`lang_id`),
  KEY `lang_id` (`lang_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='hold useromer time zone format eg.±hh:mm, ±hhmm';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='dongle delivery information';
...
CREATE TABLE IF NOT EXISTS `mst_faq` (
  ...
  `faq_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'This field would store a brief summary of the FAQ entry',
  `reg_date` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mst_feedback` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int UNSIGNED NOT NULL,
  `feedback_content` text COLLATE utf8mb4_general_ci NOT NULL,
  `feedback_rating` tinyint UNSIGNED NOT NULL COMMENT 'rating 1 to 5',
  `is_deleted` tinyint UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='customer feedback ';
...
CREATE TABLE IF NOT EXISTS `mst_firmware` (
  ...
  `firmware_folder` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `firmware_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Table structure for table `mst_grp_partner`
--

DROP TABLE IF EXISTS `mst_grp_partner`;
CREATE TABLE IF NOT EXISTS `mst_grp_partner` (
  `id` smallint UNSIGNED NOT NULL AUTO_INCREMENT,
  `partner_id` mediumint UNSIGNED NOT NULL COMMENT 'id from lkp_user_grp_lvl_3 with grp_type as partner',
  `user_grp_lvl_3` mediumint UNSIGNED DEFAULT NULL COMMENT 'id from lkp_user_grp_lvl_3 with grp_type as normal',
  `is_deleted` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `user_grp_lvl_3` (`user_grp_lvl_3`),
  KEY `partner_id` (`partner_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='user group and partner association ';
...
CREATE TABLE IF NOT EXISTS `mst_mail_template` (
  ...
  `template_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'stores mail template name',
  `mail_classification_id` smallint UNSIGNED NOT NULL COMMENT 'sending a package, newsletter, test mail, event news',
  `template_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'This field will store a brief title or summary of the mail template',
  `template_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'stores the text content of mail',
...
CREATE TABLE IF NOT EXISTS `mst_package` (
  ...
  `package_version` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `deployment_type_id` smallint UNSIGNED NOT NULL COMMENT 'Full package, Temporary package',
  `revision` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Deployment SVNRegation',
...
CREATE TABLE IF NOT EXISTS `mst_package_files` (
  ...
  `package_link_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `file_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `package_hash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `package_passwd` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reg_date` datetime NOT NULL,
  `availability_id` smallint UNSIGNED NOT NULL DEFAULT '1',
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `mst_package_patch` (
  ...
  `package_id` int UNSIGNED NOT NULL,
  `patch_version` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `patch_hash` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `patch_link_name_en` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `patch_link_name_ko` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mst_package_release_notes` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `package_id` int UNSIGNED NOT NULL,
  `release_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `release_attachment` blob NOT NULL,
  `release_xml` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `is_deleted` tinyint NOT NULL DEFAULT '0',
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  KEY `package_id` (`package_id`),
...
CREATE TABLE IF NOT EXISTS `mst_prod_lang` (
  ...
  `prod_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mst_resource` (
  ...
  `resource_passwrd` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reg_date` datetime NOT NULL,
  `is_deleted` tinyint NOT NULL DEFAULT '0',
  `availability_id` smallint UNSIGNED NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `mst_user` (
  ...
  `user_grp_lvl_1_id` mediumint UNSIGNED DEFAULT NULL COMMENT 'research institute, LG Display, Ethics Office, SK Infosec etc',
  `user_grp_lvl_2_id` mediumint UNSIGNED DEFAULT NULL,
  `user_grp_lvl_3_id` mediumint UNSIGNED DEFAULT NULL,
  `role_id` smallint UNSIGNED DEFAULT NULL COMMENT 'QA, front/support team, super admin',
  `user_cate_id` smallint UNSIGNED DEFAULT NULL COMMENT 'Police, ED, R & D Institute',
  ...
  `user_dateformat_id` smallint UNSIGNED NOT NULL,
  `user_timezone_id` smallint UNSIGNED NOT NULL,
  `passwd` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `remarks` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `created_by` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'email id',
  `Approved_by` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'email id of approved person',
  `user_status_id` smallint UNSIGNED NOT NULL COMMENT 'in verification -admin added, registered -user register, active',
  `is_deleted` tinyint NOT NULL DEFAULT '0',
  `lang_id` smallint UNSIGNED NOT NULL DEFAULT '1',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `pri_email` (`pri_email`),
  KEY `idx_role_id` (`role_id`),
  KEY `idx_user_cate_id` (`user_cate_id`),
  KEY `idx_user_group_id` (`user_grp_lvl_1_id`),
  KEY `country_id` (`country_id`),
  KEY `user_status_id` (`user_status_id`),
  KEY `lang_id` (`lang_id`),
  KEY `user_dateformat_id` (`user_dateformat_id`),
  KEY `user_timezone_id` (`user_timezone_id`),
  KEY `user_grp_lvl_2_id` (`user_grp_lvl_2_id`),
  KEY `user_grp_lvl_3_id` (`user_grp_lvl_3_id`)
...
CREATE TABLE IF NOT EXISTS `mst_whats_new` (
  ...
  `whats_new_content` blob,
  `whats_new_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'url link for youtube or any social media',
...
CREATE TABLE IF NOT EXISTS `txn_mail_detail` (
  ...
  `mail_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'email id of useromer',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='holds mail id of individual user';
...
CREATE TABLE IF NOT EXISTS `txn_noti` (
  ...
  `noti_message` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `reg_date` datetime NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='stores resource download log of useromer';
...
--
-- Table structure for table `txn_user_roundkey`
--

DROP TABLE IF EXISTS `txn_user_roundkey`;
CREATE TABLE IF NOT EXISTS `txn_user_roundkey` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int UNSIGNED NOT NULL,
...
--
-- Constraints for table `lkp_user_cate`
--
ALTER TABLE `lkp_user_cate`
  ADD CONSTRAINT `lkp_user_cate_ibfk_1` FOREIGN KEY (`lang_id`) REFERENCES `lkp_lang` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `lkp_user_dateformat`
--
ALTER TABLE `lkp_user_dateformat`
  ADD CONSTRAINT `lkp_user_dateformat_ibfk_1` FOREIGN KEY (`lang_id`) REFERENCES `lkp_lang` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `lkp_user_status`
--
ALTER TABLE `lkp_user_status`
  ADD CONSTRAINT `lkp_user_status_ibfk_1` FOREIGN KEY (`lang_id`) REFERENCES `lkp_lang` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `lkp_user_timezone`
--
ALTER TABLE `lkp_user_timezone`
  ADD CONSTRAINT `lkp_user_timezone_ibfk_1` FOREIGN KEY (`lang_id`) REFERENCES `lkp_lang` (`id`) ON DELETE RESTRICT;
...
ALTER TABLE `mst_dongle_key_dlivery`
  ADD CONSTRAINT `mst_dongle_key_dlivery_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT,
  ...
  ADD CONSTRAINT `mst_dongle_key_dlivery_ibfk_4` FOREIGN KEY (`availability_id`) REFERENCES `lkp_availability` (`id`) ON DELETE RESTRICT;
...
--
-- Constraints for table `mst_feedback`
--
ALTER TABLE `mst_feedback`
  ADD CONSTRAINT `mst_feedback_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT;
...
--
-- Constraints for table `mst_grp_partner`
--
ALTER TABLE `mst_grp_partner`
  ADD CONSTRAINT `mst_grp_partner_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `lkp_user_grp_lvl_3` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_grp_partner_ibfk_2` FOREIGN KEY (`user_grp_lvl_3`) REFERENCES `lkp_user_grp_lvl_3` (`id`) ON DELETE RESTRICT;
...
ALTER TABLE `mst_role_module`
  ...
  ADD CONSTRAINT `mst_role_module_ibfk_4` FOREIGN KEY (`role_id`) REFERENCES `lkp_role` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `mst_user`
--
ALTER TABLE `mst_user`
  ADD CONSTRAINT `mst_user_ibfk_1` FOREIGN KEY (`user_grp_lvl_2_id`) REFERENCES `lkp_user_grp_lvl_2` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_10` FOREIGN KEY (`lang_id`) REFERENCES `lkp_lang` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_2` FOREIGN KEY (`user_grp_lvl_3_id`) REFERENCES `lkp_user_grp_lvl_3` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_3` FOREIGN KEY (`user_grp_lvl_1_id`) REFERENCES `lkp_user_grp_lvl_1` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_4` FOREIGN KEY (`country_id`) REFERENCES `lkp_country` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_5` FOREIGN KEY (`role_id`) REFERENCES `lkp_role` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_6` FOREIGN KEY (`user_cate_id`) REFERENCES `lkp_user_cate` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_7` FOREIGN KEY (`user_dateformat_id`) REFERENCES `lkp_user_dateformat` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_8` FOREIGN KEY (`user_timezone_id`) REFERENCES `lkp_user_timezone` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_user_ibfk_9` FOREIGN KEY (`user_status_id`) REFERENCES `lkp_user_status` (`id`) ON DELETE RESTRICT;
...
ALTER TABLE `txn_audit_trial`
  ...
  ADD CONSTRAINT `txn_audit_trial_ibfk_2` FOREIGN KEY (`operated_by`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT;

--
-- Constraints for table `txn_firmware_download`
--
ALTER TABLE `txn_firmware_download`
  ADD CONSTRAINT `txn_firmware_download_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT,
...
ALTER TABLE `txn_hubspot_ticket`
  ADD CONSTRAINT `txn_hubspot_ticket_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `txn_hubspot_ticket_ibfk_2` FOREIGN KEY (`ticket_status_id`) REFERENCES `lkp_ticket_status` (`id`) ON DELETE RESTRICT;
...
ALTER TABLE `txn_noti`
  ADD CONSTRAINT `txn_noti_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `txn_noti_ibfk_2` FOREIGN KEY (`noti_type_id`) REFERENCES `lkp_noti_type` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `txn_noti_ibfk_3` FOREIGN KEY (`noti_status_id`) REFERENCES `lkp_noti_status` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `txn_package_download`
--
ALTER TABLE `txn_package_download`
  ADD CONSTRAINT `txn_package_download_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT,
...
ALTER TABLE `txn_resource_download`
  ADD CONSTRAINT `txn_resource_download_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT,
...
ALTER TABLE `txn_session`
  ADD CONSTRAINT `txn_session_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT;

--
-- Constraints for table `txn_user_roundkey`
--
ALTER TABLE `txn_user_roundkey`
  ADD CONSTRAINT `txn_user_roundkey_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`user_id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `txn_user_roundkey_ibfk_2` FOREIGN KEY (`prod_id`) REFERENCES `mst_prod` (`prod_id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `txn_user_roundkey_ibfk_3` FOREIGN KEY (`dongle_id`) REFERENCES `mst_dongle_key` (`dongle_id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `txn_user_roundkey_ibfk_4` FOREIGN KEY (`availability_id`) REFERENCES `lkp_availability` (`id`) ON DELETE RESTRICT;
COMMIT;
