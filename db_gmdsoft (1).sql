...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 16, 2024 at 03:56 AM
...
--
-- Table structure for table `lkp_email_content`
--

DROP TABLE IF EXISTS `lkp_email_content`;
CREATE TABLE IF NOT EXISTS `lkp_email_content` (
  `id` smallint UNSIGNED NOT NULL,
  `email_content` text COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Table structure for table `lkp_resource_file_path`
--

DROP TABLE IF EXISTS `lkp_resource_file_path`;
CREATE TABLE IF NOT EXISTS `lkp_resource_file_path` (
  `id` smallint UNSIGNED NOT NULL,
  `resource_file_path` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `lang_id` smallint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`,`lang_id`),
  KEY `lang_id` (`lang_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `mst_admin_user_guide` (
  ...
  `admin_user_guide_id` smallint UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mst_firmware` (
  ...
  `firmware_type_id` smallint NOT NULL,
...
--
-- Table structure for table `mst_mail_grp`
--

DROP TABLE IF EXISTS `mst_mail_grp`;
CREATE TABLE IF NOT EXISTS `mst_mail_grp` (
  `mail_grp_id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `mail_grp_name_id` smallint UNSIGNED NOT NULL,
  `mail_grp_type_id` smallint UNSIGNED NOT NULL,
  `reg_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `remarks` text COLLATE utf8mb4_general_ci,
  PRIMARY KEY (`mail_grp_id`),
  KEY `mail_grp_name_id` (`mail_grp_name_id`),
...
CREATE TABLE IF NOT EXISTS `mst_resource` (
  ...
  `resource_file_path_id` smallint UNSIGNED NOT NULL,
  ...
  KEY `resource_file_path_id` (`resource_file_path_id`),
...
CREATE TABLE IF NOT EXISTS `txn_mail` (
  ...
  `mail_grp_id` int UNSIGNED NOT NULL,
...
--
-- Constraints for table `lkp_resource_file_path`
--
ALTER TABLE `lkp_resource_file_path`
  ADD CONSTRAINT `lkp_resource_file_path_ibfk_1` FOREIGN KEY (`lang_id`) REFERENCES `lkp_lang` (`id`) ON DELETE RESTRICT;
...
--
-- Constraints for table `mst_mail_grp`
--
ALTER TABLE `mst_mail_grp`
  ADD CONSTRAINT `mst_mail_grp_ibfk_1` FOREIGN KEY (`mail_grp_name_id`) REFERENCES `lkp_mail_grp_name` (`id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_mail_grp_ibfk_2` FOREIGN KEY (`mail_grp_type_id`) REFERENCES `lkp_mail_grp_type` (`id`) ON DELETE RESTRICT;
...
ALTER TABLE `mst_resource`
  ADD CONSTRAINT `mst_resource_ibfk_1` FOREIGN KEY (`resource_file_path_id`) REFERENCES `lkp_resource_file_path` (`id`) ON DELETE RESTRICT,
