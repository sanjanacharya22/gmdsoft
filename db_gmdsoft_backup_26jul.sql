...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 26, 2024 at 03:43 PM
...
--
-- Table structure for table `mst_package_hash`
--

DROP TABLE IF EXISTS `mst_package_hash`;
CREATE TABLE IF NOT EXISTS `mst_package_hash` (
...
--
-- Constraints for table `mst_package_hash`
--
ALTER TABLE `mst_package_hash`
  ADD CONSTRAINT `mst_package_hash_ibfk_1` FOREIGN KEY (`package_id`) REFERENCES `mst_package` (`package_id`) ON DELETE RESTRICT,
  ADD CONSTRAINT `mst_package_hash_ibfk_2` FOREIGN KEY (`availability_id`) REFERENCES `lkp_availability` (`id`) ON DELETE RESTRICT;
